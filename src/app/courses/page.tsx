...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Cohort-based courses on the things that quietly shape a life.",
  },
};
        ...
        <div className="mt-20 divide-y divide-border/70 border-y border-border/70">
          {courses.map((c) => (
            <Link
              key={c.num}
              href="#"
              className="group grid grid-cols-12 items-center gap-4 py-8 transition hover:bg-secondary/40 md:py-10"
            >
